          ...
          <li style="margin-left:335px">
            <router-link to="menupurchase"><a href="dashbaord">
              <font style="vertical-align: inherit"
                ><font style="vertical-align: inherit">Recept-Order</font></font>
            </a>
            </router-link>
          </li>
        </ol>
    ...
    <div class="search-box">
      <div id="product">
        ...
        <div class="search-box mb-4">
          ...
          <div class="search-box-content">
            <table
              ...
              cellpadding="0"
              cellspacing="0"
              class="tbl_search" id="hover-table"
            >
              <tbody>
                <tr>
        ...
        <div class="box">
                  ...
                  >
                    <div class="up-del-btn">
                      <div class="button type2" id="uniform-undefined">
                        <span
                          ><input
                            @click="getEdit(purchase.document_no)"
                            type="button"
                            value="display"
                            class="type2"
                            style="opacity: 0; width: 54px"
          ...
          <div class="box-footer-pagination">
              <pagination :data="purchases" @pagination-change-page="getPurchase" />
            </div>
        </div>
      </div>
    </div>
                ...
                <div style="padding:0 100px">
                  <div class="col-md-12">
                    <div class="text-center">
                      <h3 class="title-purchase">ALL RECEPTS REPORT</h3>
                    </div>
                  </div>
                  ...
                  <div class="col-container">
                    ...
                    <div class="col2">
                      ...
                      <p class="text-center p-bg font-size p-pad">TOTAL RECEPT</p>
                      <p class="text-center p-mg">{{ purchases.total }}</p>
                    </div>
                  </div>
          ...
          .then(({ data }) => {
            ...
            this.links.forEach((element) => {
              if (element.label == page) {
                this.perPage =
                  "/api/v1/receive/getrecpt/?page=" + page;
