...
class Saleline extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('saleline', function (Blueprint $table) {
            $table->id();
    ...
    {
        DB::statement('DROP VIEW IF EXISTS Saleline');        Schema::create('Saleline', function (Blueprint $table) {
            $table->id();
            $table->string("document_no", 25)->nullable();
            $table->string("document_type", 250)->nullable();
            $table->string("product_no", 25)->nullable();
