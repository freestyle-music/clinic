<template>
    <div class="wrapper">
      ...
      <h1 id="title" _msttexthash="48503" _msthash="2">Stock-Transection</h1>
    </div>
            <Header />
            <ol id="topicPath">
          <li style="margin-left:370px">
            <router-link to="menustock"><a href="dashbaord">
              <font style="vertical-align: inherit"
                ><font style="vertical-align: inherit">Stock-Transection</font></font>
            </a>
            </router-link>
          </li>
        </ol>
          ...
          <div class="card">
            <div class="card-body" >
              <div class="mt-3 print-size"  >
                ...
                <div style="padding:0 50px 0 50px; background-color: #fff;">
                  <div class="col-md-12">
